    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('status', function(Product $data) {
                                $isActivated = $data->status == 1 ? 'Activated' : 'Deactivated';
                                $class = $data->status == 1 ? 'green' : 'red';
                                return '<div class="action-list"><a href="javascript:;" style="background-color: '.$class.';">'.$isActivated.'</a></div>';
                            })
...
//                $input['childcategory_id'] = $request->childcategory_id;
    ...
    public function store(Request $request)
    {
        ...
        //--- Redirect Section
        $msg = 'New Product Added Successfully <br/> Wait for product to be activate by <b>admin</b>.<a href="'.route('vendor-prod-index').'">View Product Lists.</a>';
        return response()->json($msg);
        //--- Redirect Section Ends
        }
        else
