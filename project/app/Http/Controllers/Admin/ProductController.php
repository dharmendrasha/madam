...
class ProductController extends Controller
{
    ...
    {
         $datas = Product::where('product_type','=','normal')->orderBy('id','desc')->paginate(10);
         return view('includes.custom.allProductsAdmin', ['datas' => $datas]);
    ...
    public function index()
    {
        ...
        $datas = Product::where('product_type','=','normal')->orderBy('id','desc')->paginate($limit);
        $count = Product::where('product_type','=','normal')->orderBy('id','desc')->get();
        $total = count($count);
        
        return view('admin.product.index',['datas' => $datas, 'showing' => $show, 'total' => $total, 'page' => $page]);
    }
