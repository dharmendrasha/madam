...
class UserController extends Controller
{
    ...
    public function vendorrequestsub(Request $request)
    {
        ...
        $settings = Generalsetting::findOrFail(1);
                    ...
                    mail($user->email,'Your Vendor Account Activated','You hav success fully bought a plan, Please wait for activation from admin. Please Login to your account and build your own shop.',$headers);
                    }

                    return redirect()->route('user-dashboard')->with('success','You have successfully selected the plan Please wait for activation by admin');
