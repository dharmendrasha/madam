...
<?php endif; ?>
	...
	<center class="bg-dark desktop_view" id="mayShow">
	<nav class="navbar container navbar-expand-lg navbar-light">
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
		  <ul class="navbar-nav auto_height row">
			<?php
			$i=1;
			?>
			<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<li class="col nav-item yellow  active <?php echo e(count($category->subs) > 0 ? 'dropdown':''); ?>">
			  <a class="nav-link word-break text-white <?php echo e(count($category->subs) > 0 ? 'dropdown-toggle':''); ?>" id="<?php echo e(count($category->subs) > 0 ? $category->slug :''); ?>" aria-haspopup="<?php echo e(count($category->subs) > 0 ? 'true' :'false'); ?>" aria-expanded="<?php echo e(count($category->subs) > 0 ? 'false' :'false'); ?>" <?php echo e(count($category->subs) > 0 ? "data-toggle='dropdown'":''); ?> <?php echo e(count($category->subs) > 0 ? "role='button'":''); ?> href="<?php echo e(count($category->subs) > 0 ? '#' : route('front.category',$category->slug)); ?>"><?php echo e($category->name); ?></a>
			 ...
			 <div class="dropdown-menu" aria-labelledby="<?php echo e($category->slug); ?>">
				...
				<a class="dropdown-item" href="<?php echo e(route('front.subcat',['slug1' => $subcat->category->slug, 'slug2' => $subcat->slug])); ?>"><?php echo e($subcat->name); ?></a>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			  </div>
			 <?php endif; ?>
			</li>
			...
			<?php if($i == 7): ?>
				<li>
				<a class="text-white" href="<?php echo e(route('front.categories')); ?>"><i class="fas fa-plus"></i> <?php echo e($langg->lang15); ?> </a>
				</li>
				<?php break; ?>
			<?php endif; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	...
	<div class="mainmenu-area mainmenu-bb" id="mayHide">
		<div class="container">
			...
			<div class="row align-items-center mainmenu-area-innner">
				...
				<div class="col-lg-3 col-md-6 categorimenu-wrapper remove-padding">
					<!--categorie menu start mobile view-->
							...
							<div class="login-area signup-area">
								...
								<div class="login-form signup-form">
									...
									<form class="mregisterform" action="<?php echo e(route('user-register-submit')); ?>"
										...
										<small>By continuing this you are agree to our terms and conditions.</small>
  ...
  var langg    = <?php echo json_encode($langg); ?>;
	...
	<?php echo $__env->yieldContent('scripts'); ?>
		...
		<script>
			...
			$(function(){
					function hideFun(wid){
						var elem = document.getElementById('mayHide');
						if(wid > 1000){
					...
					function showFun(wid){
						var elem = document.getElementById('mayShow');
						if(wid < 1000){
							elem.classList.add('hide');
						}else{
							if(elem.classList.contains('hide')){
				...
				hideFun(window.innerWidth);
				showFun(window.innerWidth);
