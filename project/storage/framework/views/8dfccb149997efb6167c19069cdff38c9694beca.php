												...
												<div class="row">
													<div class="col-lg-12">
														<div class="nav flex-column"  role="tablist" aria-orientation="vertical">
														    <?php if(\Auth::user()): ?>
														    <?php if( \Auth::user()->wallet >= $totalPrice): ?>
														<a class="nav-link payment" data-val="" data-show="no" id="v-pills-tab1-tab" data-toggle="pill" href="#v-pills-tab1" role="tab" aria-controls="v-pills-tab1" aria-selected="true">
															<div class="icon">
														...
														<p>
															...
															<small>Your current balance is <?php echo e($curr->sign); ?><?php echo e(\Auth::user()->wallet); ?></small>
