                                                ...
                                                <table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><?php echo e(__('Update Orders')); ?></th>
                                                            <th><?php echo e(__('After Delivery')); ?></th>
    ...
    <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
               ...
               columns: [
                        ...
                        { data: 'Update', searchable: false, orderable: false },
                        { data: 'After', searchable: false, orderable: false },
                        { data: 'vendor_Status', searchable: true, orderable: false}
                     ],
               language : {
