...
Route::prefix('admin')->group(function() {
  ...
  // custom 
  Route::get('/order/update/{id}', 'Admin\OrderController@updateOrder')->name('admin-order-update-custom');
  Route::post('/order/update/post/{id}', 'Admin\OrderController@updateOrderPost')->name('admin-order-update-post');
...
Route::group(['middleware'=>'permissions:super'],function(){
  ...
  Route::get('/role/delete/{id}', 'Admin\RoleController@destroy')->name('admin-role-delete');
        ...
        // wallet settings
    // wallet working
Route::get('wallet', 'walletController@admin_update')->name('wallet');
Route::post('wallet/update', 'walletController@update_wallet')->name('wallet.update');
...
Route::prefix('user')->group(function() {
  ...
  Route::get('/wallet', 'walletController@user')->name('user-wallet');
  ROute::post('/wallet/update/post', 'walletController@update_wallet_user')->name('user-wallet-update');
...
Route::get('product_value/after_sell/{order_number}/{status}', 'User\OrderController@orderUpdateAfterSell')->name('order_update_after_sell');


//
//Route::post('wallet/update/user/side', 'walletController@update_wallet_user')->name('wallet.update.user');
